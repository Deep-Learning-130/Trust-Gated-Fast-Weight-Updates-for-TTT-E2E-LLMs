...
carries Sections I–III plus a 35-entry bibliography and states explicitly that it _reports
no measurements_. `intro-related-work.tex` is the superseded earlier snapshot. Results,
...
- **Repository visibility. Nobody changes it.** Public since 2026-08-01, deliberate since
  2026-08-02. A push to a _new_ remote is a separate decision that gets recorded first.
