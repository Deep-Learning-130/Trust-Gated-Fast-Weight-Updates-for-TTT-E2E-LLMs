...
2. **CPU tests pass:** `PYTHONPATH=src JAX_PLATFORMS=cpu pytest` — **197 tests** as of
   2026-09-14. The count is expected to grow; a branch that *reduces* it is the thing to
